...
class TransactionRequestsControllerTest < ActionController::TestCase
  ...
  test "should create transaction_request" do
    assert_difference('TransactionRequest.count') do
      post :create, transaction_request: { date: @transaction_request.date, input_address_id: @transaction_request.input_address_id, output_address: @transaction_request.output_address, output_address_cryptocurrency_id: @transaction_request.output_address_cryptocurrency_id }
    end
  ...
  test "should update transaction_request" do
    patch :update, id: @transaction_request, transaction_request: { date: @transaction_request.date, input_address_id: @transaction_request.input_address_id, output_address: @transaction_request.output_address, output_address_cryptocurrency_id: @transaction_request.output_address_cryptocurrency_id }
    assert_redirected_to transaction_request_path(assigns(:transaction_request))
  end
